...
- **Offen:** Reader-NEU-Upload durch Patrycja (Ordner `astro-eklipsen-reader-netlify` mit v15 auf eclipsenavigator.netlify.app — Live-Version hat den Ortssuche-Fix noch nicht!) + Live-Gegentest mit Melle · Salespage-Upload durch Patrycja (Ordner `eclipse-navigator-salespage-netlify` per Netlify Drop; Ziel-Site klären) · kompletter Kaufketten-Test vor Verkaufsstart (Salespage-Button → Checkout angebot.lieblingsastrologin.de/eclipse-navigator/ → Kauf → Danke-Seite mit Passwort → eclipsenavigator.netlify.app → Finsternis2026) · optional eigener Abschluss-CTA im Reader · Ideen für Patrycjas eigene Reader: Passwort-Gate-Muster, robuste Ortssuche (v15), schmaleres Zeilenmaß, wahrer Knoten (true-node-data.js), Engine einbetten statt CDN, Zeit-Tippfeld.
