...
- **Offen:** Salespage-Upload durch Patrycja (Ordner `eclipse-navigator-salespage-netlify` per Netlify Drop; Ziel-Site klären) · kompletter Kaufketten-Test vor 29.07. (Salespage-Button → Checkout angebot.lieblingsastrologin.de/eclipse-navigator/ → Kauf → Danke-Seite mit Passwort → eclipsenavigator.netlify.app → Finsternis2026) · optional eigener Abschluss-CTA im Reader · Ideen für Patrycjas eigene Reader: Passwort-Gate-Muster, schmaleres Zeilenmaß, wahrer Knoten (true-node-data.js), Engine einbetten statt CDN, Zeit-Tippfeld.
