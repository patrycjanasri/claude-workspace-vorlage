...
- **Offen:** Name endgültig bestätigen (falls „Navigator" bleibt: fertig) · optional eigener Abschluss-CTA auf ihr Angebot (+ evtl. Foto dort) · Netlify-Upload in IHREM Account (URL nicht erratbar) · Testkauf/Verkaufsweg klärt sie · Patricia-Feinschliff falls gewünscht · Ideen für Patrycjas eigene Reader: schmaleres Zeilenmaß, wahrer Knoten (true-node-data.js), Engine einbetten statt CDN.
