...
- **Offen:** Name endgültig bestätigen (falls „Navigator" bleibt: fertig) · Upload der v13 durch Patrycja/Bernadette (Datei übergeben) + Live-Check auf resplendent-basbousa · optional eigener Abschluss-CTA auf ihr Angebot · Testkauf/Verkaufsweg klärt sie · Ideen für Patrycjas eigene Reader: schmaleres Zeilenmaß, wahrer Knoten (true-node-data.js), Engine einbetten statt CDN, Zeit-Tippfeld.
