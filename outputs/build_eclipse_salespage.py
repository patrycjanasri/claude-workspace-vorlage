...
<section class="sec-bekommst">
  <div class="wrap narrow">
    ...
    <p class="bek-lead">Eine vollst&auml;ndige astrologische Deutung</p>
    <p class="anton bek-zahl">in drei Teilen</p>
...
<section class="sec-steps">
  <div class="wrap narrow">
    ...
    <div class="step"><div class="step-num">03</div><p>Danach bekommst Du eine vollst&auml;ndige Deutung in drei Teilen, nur f&uuml;r Dich.</p></div>
    <span class="gold"></span>
...
<section class="sec-faq">
  <div class="wrap">
    ...
    <div class="faq">
      ...
      <details><summary>Was mache ich, wenn etwas hakt?</summary><div class="a"><p>Die Seite l&auml;dt oder rechnet nicht? Leere den Browser-Cache oder nutze einen anderen Browser, am besten ein aktuelles Chrome oder Safari. Falls ChatGPT oder Claude zickt und Dir keine Antwort geben m&ouml;chte, &ouml;ffne einfach ein neues Chatfenster und gib den Prompt erneut ein! F&uuml;r das h&ouml;chste Ergebnis stelle ChatGPT oder Claude auf die h&ouml;chste Stufe. Dein Geburtsort wird nicht gefunden? Gib die n&auml;chstgr&ouml;&szlig;ere Stadt ein. Du kommst nicht weiter? Schreib mir, ich helfe Dir.</p></div></details>
    </div>
  </div>
</section>
